...
import com.tivit.inventariodmt.RFID.DotR900.R900RecvPacketParser;
import com.tivit.inventariodmt.TestActivity;
...
public class Leitor {
    ...
    public List<String> getListaPatrimonio() {
        return listaPatrimonio;
    }

    public String getLastTag(){
        return listaPatrimonio.get((listaDispositivo.size()-1));
    }

    private List<String> listaPatrimonio = new ArrayList<>();
...
//        if (!listaPatrimonio.contains(tagRFId))
            listaPatrimonio.add(tagRFId);
    }
