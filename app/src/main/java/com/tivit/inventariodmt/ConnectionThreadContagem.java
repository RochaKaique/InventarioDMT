...
/**
 * Created by kaique.rocha on 09/11/2016.
 */

public class ConnectionThreadContagem extends Thread {
     ...
     */
    public ConnectionThreadContagem() {
     ...
     */
    public ConnectionThreadContagem(String btDevAddress) {
    ...
    private void toMainActivity(byte[] data) {
        ...
        ContagemActivity.handler.sendMessage(message);
    }
